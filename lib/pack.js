...
module.exports = async (entrypoint, _opts={})=>{
	...
	const pack = async ()=>{
		...
		const clientSideHydrate = `;start_app=(props={},target=document.getElementById('reactRoot')[0])=>require('react-dom').hydrate(require('react').createElement(${opts.name}, props),target);`
